...
<CustomImage
  src="https://raw.githubusercontent.com/theboywholivedd/blogposts/main/images/image.avif"
  alt="Next js is cool"
/>
You can import modules in top-level scope for use in `getServerSideProps`. Imports
used will **not be bundled for the client-side**. This means you can write **server-side
code directly in `getServerSideProps`**, including fetching data from your database.
